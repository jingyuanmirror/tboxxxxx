...
export default function MagicInput({ onSendMessage }: MagicInputProps) {
  ...
  const handleSend = () => {
    ...
    onSendMessage?.(inputValue, selectedModel?.key);
    setInputValue('');
  };
        ...
        <div className="flex gap-2 items-center">
          ...
          {selectedMode && (
            <div className="flex items-center gap-1.5 relative -top-[3px] text-[#1a73e8]">
              ...
              <button onClick={() => setSelectedMode(null)} className="w-4 h-4 flex items-center justify-center hover:text-[#174ea6] cursor-pointer transition-colors ml-0.5">
